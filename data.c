...
int main(){
	...
	scanf("%d",&choice);
	while(choice){
		printf("Please enter the name of the admin: ");               //create admin records
		scanf(" %[^\n]",newAdmin.username);
		printf("Please enter the password(max 10 characters): ");
		scanf(" %[^\n]",newAdmin.password);
	...
	scanf("%d",&choice);
	while(choice){
		printf("Please enter the name of the normal user: ");      //create normal user records
		scanf(" %[^\n]",newNUser.name);
		printf("Please enter the password(max 10 characters): ");
		scanf(" %[^\n]",newNUser.password);
	...
	scanf("%d",&choice);
	while(choice){
		printf("Please enter the main name of the joint user: ");      //create joint user records
		scanf(" %[^\n]",newJUser.name1);
		printf("Please enter the second name of the joint user: ");
		scanf(" %[^\n]",newJUser.name2);
		printf("Please enter the password(max 10 characters): ");
